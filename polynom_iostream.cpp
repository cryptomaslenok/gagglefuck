...
int main()
{
    ...
    double x, x6, x4, x2, first_step, second_step, third_step, fouth_step, fifth_step, poly;
    ...
    poly2 = y3 * ((5.0001 * pow(y, 3) - (3.0001 * y) - 9.0001));
    ...
    cout << endl;
    cout << endl;
    cout << "result of dividing - "<< setprecision(3) << trudiv << endl;
    cout << endl;
    cout << endl;
